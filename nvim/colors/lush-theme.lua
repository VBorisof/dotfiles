...
local sea_foam  = hsl(208, 100, 25) -- Vim has a mapping, <n>C-a and <n>C-x to
...
local deep_blue = total_black.lighten(15)
local total_white = hsl(0, 0, 100)
local acid_green = hsl(117, 100, 48)

local main_lush_theme = lush(function()
  return {
